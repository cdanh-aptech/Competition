<?php return array (
  ...
  array (
    ...
    array (
      ...
      'JSTrackingIntro3b' => 'In most websites, blogs, CMS, etc. you can use a pre-made plugin to do the technical work for you. (See our %1$slist of plugins used to integrate Matomo%2$s.) If no plugin exists you can edit your website templates and add the JavaScript tracking code to the &lt;/head&gt; tag   which is often defined in a \'header.php\', \'header.tpl\' or similar template file.',
