...
class __TwigTemplate_65dbe12202f07f796781bd011d371007e4d9387bd80b6c7c85a9e371d2999b15 extends \Twig\Template
{
        ...
        ";
            ...
            if ((($context["latest_version_available"] ?? $this->getContext($context, "latest_version_available")) && ($context["isSuperUser"] ?? $this->getContext($context, "isSuperUser")))) {
                ...
                if (($context["isMultiServerEnvironment"] ?? $this->getContext($context, "isMultiServerEnvironment"))) {
                    // line 39
                    echo "                ";
                    echo call_user_func_array($this->env->getFilter('translate')->getCallable(), ["CoreHome_OneClickUpdateNotPossibleAsMultiServerEnvironment", (("<a rel='noreferrer noopener' href='https://builds.matomo.org/piwik-" . ($context["latest_version_available"] ?? $this->getContext($context, "latest_version_available"))) . ".zip'>"), "</a>"]);
                    echo "
            ";
                } else {
                    // line 41
...
<span class=\"icon icon-arrowup\"></span>
{% endif %}
", "@CoreHome/_headerMessage.twig", "D:\\APTECH\\PHP\\Website\\Competition\\analytics\\plugins\\CoreHome\\templates\\_headerMessage.twig");
    }
}
