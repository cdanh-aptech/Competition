    ...
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/tacpham/danhsach">Danh sách</a>
                    </li>
                    <li>
                        <a href="admin/tacpham/them">Thêm mới</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/result/danhsach">Danh sách</a>
                    </li>
                    <li>
                        <a href="admin/result/them">Thêm mới</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
